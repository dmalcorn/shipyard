...
- Tier 1 files are _not_ automatically loaded — they're available via the dev agent's `Read` tool on demand. If a rule cites a lesson and the agent wants the full context, it can fetch it itself.
